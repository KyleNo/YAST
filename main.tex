...
All the text that follows ``\texttt{@player }'' will be sent to the player who executes the script when this line runs. Before the text is sent, however, it is formatted. Formatting options greatly enhance the expression capabilities of scripts. 
